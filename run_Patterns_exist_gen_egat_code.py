...
from graph_generator_Patterns_exist_egat_gen import GraphGenerator
...
DEBUG_CONFIG = {
    ...
    "save_data_dir": r"./data/debug_Patterns_exist_egat_code_gen_all",
    "num_workers": 1,
    "existing_pattern_dir": r"E:\wyh\layout\code\NeuralSubgraphCounting-change\data\debug_Patterns_exist_egat_code_gen_all\patterns"  # 新增配置项：已有pattern的目录路径
}
