...
class GraphGenerator(object):
    def __init__(self, pattern):
        ...
        self.number_of_pattern_vertex_labels = len(set(self.pattern.vs["label"]))  # 实际使用的顶点标签种类数
        self.number_of_pattern_edge_labels = len(set(self.pattern.es["label"]))    # 实际使用的边标签种类数
